 ...
 * \brief Control object providing RayonixHs shutter interface
 *******************************************************************/

	class ShutterCtrlObj : public HwShutterCtrlObj
	{
	    DEB_CLASS_NAMESPC(DebModCamera, "ShutterCtrlObj", "RayonixHs");
...
#endif // RAYONIXHSSHUTTERCTRLOBJ_H
