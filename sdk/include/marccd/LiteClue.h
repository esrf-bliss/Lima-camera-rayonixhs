...
/* Revision History:
$Log: LiteClue.h,v $
Revision 2.0  2003-05-15 13:01:53  marccd
Update revisions to 2.0 - needed to remove 0.x revisions to get :ext: commit
to work properly

Revision 1.1  2003/02/27 04:33:01  marccd
More changes for mosaic
pulled out all references to specific axes in gonisotat files in anticipation
of adding more axes for CSC and generally generalizing
Drive,Init buttons in goniostat window
LiteClue added to give bubble help
Tabs used for new sidebar which will contain zoom/crystal alignment
goniostat ace,taco,spec no longer linked in -too out of date
