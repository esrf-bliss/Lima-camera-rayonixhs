#ifndef goniostat_mmx0P_h
#define goniostat_mmx0P_h

#include "marccd_signal.h"

#define TIMEOUT_SECS	5
#define HOLD_CURRENT	30
#define RUN_CURRENT	100
...
static char *printf_goniostat_mmx0(char * format, ...);
...
#if defined(SYSV_SIGNAL_HANDLING) || defined(BSD_SIGNAL_HANDLING)
